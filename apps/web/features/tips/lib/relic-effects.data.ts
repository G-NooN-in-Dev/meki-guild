import { createRelicStat, stageFlat, stagePercent, stageValue } from '@/features/tips/lib/relic-stat.helpers'
import type { RelicAwakeningStage, RelicStatEffect } from '@/features/tips/types/relic.type'

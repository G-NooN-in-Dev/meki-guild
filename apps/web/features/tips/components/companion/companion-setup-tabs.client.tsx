...
import CompanionEffectTable from '@/features/tips/components/companion/companion-effect-table'
import CompanionSetupSimulator from '@/features/tips/components/companion/companion-setup-simulator'
